...
$routes->match(['get', 'post'], 'userStore', 'UserController::store');
$routes->match(['get', 'post'], 'userUpdate', 'UserController::update');
...
$routes->get('/profile', 'UserController::getProfile',['filter' => 'authGuard']);
